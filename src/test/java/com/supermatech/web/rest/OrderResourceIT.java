...
import static com.supermatech.domain.OrderAsserts.*;
...
import com.supermatech.repository.UserRepository;
...
class OrderResourceIT {
    ...
    private static final String DEFAULT_ODR_ADRESSE = "AAAAAAAAAA";
    private static final String UPDATED_ODR_ADRESSE = "BBBBBBBBBB";

    private static final String DEFAULT_ODR_PHONENUMBER = "AAAAAAAAAA";
    private static final String UPDATED_ODR_PHONENUMBER = "BBBBBBBBBB";

    private static final Double DEFAULT_ODR_PRICE = 1D;
    private static final Double UPDATED_ODR_PRICE = 2D;

    private static final Instant DEFAULT_ODR_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_ODR_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order()
            .odr_adresse(DEFAULT_ODR_ADRESSE)
            .odr_phonenumber(DEFAULT_ODR_PHONENUMBER)
            .odr_price(DEFAULT_ODR_PRICE)
            .odr_date(DEFAULT_ODR_DATE);
        // Add required entity
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order updatedOrder = new Order()
            .odr_adresse(UPDATED_ODR_ADRESSE)
            .odr_phonenumber(UPDATED_ODR_PHONENUMBER)
            .odr_price(UPDATED_ODR_PRICE)
            .odr_date(UPDATED_ODR_DATE);
        // Add required entity
        User user = UserResourceIT.createEntity();
        em.persist(user);
        em.flush();
    ...
    @Test
    @Transactional
    void checkOdr_adresseIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        order.setOdr_adresse(null);
    ...
    @Test
    @Transactional
    void checkOdr_phonenumberIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        order.setOdr_phonenumber(null);
    ...
    @Test
    @Transactional
    void checkOdr_priceIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        order.setOdr_price(null);
    ...
    @Test
    @Transactional
    void checkOdr_dateIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        order.setOdr_date(null);
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].odr_adresse").value(hasItem(DEFAULT_ODR_ADRESSE)))
            .andExpect(jsonPath("$.[*].odr_phonenumber").value(hasItem(DEFAULT_ODR_PHONENUMBER)))
            .andExpect(jsonPath("$.[*].odr_price").value(hasItem(DEFAULT_ODR_PRICE.doubleValue())))
            .andExpect(jsonPath("$.[*].odr_date").value(hasItem(DEFAULT_ODR_DATE.toString())));
    }
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.odr_adresse").value(DEFAULT_ODR_ADRESSE))
            .andExpect(jsonPath("$.odr_phonenumber").value(DEFAULT_ODR_PHONENUMBER))
            .andExpect(jsonPath("$.odr_price").value(DEFAULT_ODR_PRICE.doubleValue()))
            .andExpect(jsonPath("$.odr_date").value(DEFAULT_ODR_DATE.toString()));
    }
