...
public class CategoryAsserts {
    ...
    public static void assertCategoryUpdatableFieldsEquals(Category expected, Category actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getCat_name()).as("check cat_name").isEqualTo(actual.getCat_name()))
            .satisfies(e -> assertThat(e.getCat_description()).as("check cat_description").isEqualTo(actual.getCat_description()));
    }
