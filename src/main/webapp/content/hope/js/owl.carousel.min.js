  ...
  var l = {
    ...
    afterGo: function () {
      ...
      this.prevItem !== this.currentItem &&
        (this.checkPagination(), this.checkNavigation(), this.eachMoveUpdate(), !1 !== this.options.autoPlay && this.checkAp());
    ...
    singleItemTransition: function () {
      ...
      a.$owlWrapper
        .addClass('owl-origin')
        .css({ '-webkit-transform-origin': g + 'px', '-moz-perspective-origin': g + 'px', 'perspective-origin': g + 'px' });
