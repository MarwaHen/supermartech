      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            pro_name: expect.any(Object),
            pro_description: expect.any(Object),
            pro_price: expect.any(Object),
            pro_quantity: expect.any(Object),
            catt_id: expect.any(Object),
            pro_date: expect.any(Object),
            pro_promotion: expect.any(Object),
            pro_mark: expect.any(Object),
